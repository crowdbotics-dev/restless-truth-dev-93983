...
## Project Structure
    ...
    ├── restless_truth_dev_93983  # Django project configurations
...
1. Clone this repo and `cd restless_truth_dev_93983`
...
2. Clone this repo and `cd restless_truth_dev_93983`
