"""
Django settings for restless_truth_dev_93983 project.
...
ROOT_URLCONF = 'restless_truth_dev_93983.urls'
...
WSGI_APPLICATION = 'restless_truth_dev_93983.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "restless_truth_dev_93983 API",
    "DESCRIPTION": "API documentation for restless_truth_dev_93983 App",
    "VERSION": "v1",
}
